...
export default function CollecteForm({ collecte, producteurs, parcelles }: CollecteFormProps) {
  ...
  const [formData, setFormData] = useState({
    producteur_id: collecte.producteur_id || "",
    parcelle_id: collecte.parcelle_id || "",
    date_collecte: collecte.date_collecte || "",
    produit: collecte.produit || "Cacao",
    poids_brut_kg: collecte.poids_brut_kg || "",
    poids_net_kg: collecte.poids_net_kg || "",
    nombre_sacs: collecte.nombre_sacs || "",
    taux_humidite: collecte.taux_humidite || "",
      ...
      <div className="grid grid-cols-2 gap-6">
        <div>
          ...
          <select
            ...
            onChange={(e) => setFormData({...formData, producteur_id: e.target.value, parcelle_id: ""})}
        ...
        <div>
          <label className="block text-gray-900 text-sm font-medium mb-2">Taux d'humidité (%)</label>
          <input
            type="number"
            step="0.1"
        ...
        <div className="col-span-2">
          <label className="block text-gray-900 text-sm font-medium mb-2">Qualité</label>
          <select
